...
**试点范围**：书页 22-23（PDF 0-based 页码 20 和 21）"第 9 周 拨片的跨弦演奏"，共 7 条乐句
（每日必弹 + 周一～周六，周日为纯文字无乐谱）。实施中经用户确认，试点交付缩减为前 3 条乐句
（每日必弹、周一、周二），先跑通全流程并验收，其余乐句与全书批量另行扩展。
...
| 试点范围 | 先做一周（跨两页 7 条，试点交付前 3 条），验收后再谈批量 |
| 文件组织 | 每周一个 .gp5，每条乐句各占一段，带 Marker 与各自速度 |
...
1. `output/week09.gp5` 能在 Guitar Pro 中打开，试点范围内的 3 条乐句齐全、Marker 与速度正确。
